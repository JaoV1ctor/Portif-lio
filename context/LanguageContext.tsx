...
const translations = {
  pt: {
    ...
    'terminal.help': 'Comandos: help, about, skills, projects, contact, social, ls, date, whoami, clear, exit',
    ...
    'terminal.social': 'Siga-me: GitHub (@JaoV1ctor), Instagram e LinkedIn.',
    'terminal.sudo': 'Permissão negada. Você não é o administrador do sistema (por enquanto).',
    'terminal.whoami': 'Usuário: guest\nContato: vibeagency.oficial@gmail.com',
    'terminal.exit': 'Terminal encerrado. Recarregue a página para abrir novamente.',
    'terminal.ls': 'about/  skills/  projects/  contact/  social/  resume.pdf',
  ...
  en: {
    ...
    'terminal.help': 'Commands: help, about, skills, projects, contact, social, ls, date, whoami, clear, exit',
    ...
    'terminal.social': 'Follow me: GitHub (@JaoV1ctor), Instagram and LinkedIn.',
    'terminal.sudo': 'Permission denied. You are not the system administrator (for now).',
    'terminal.whoami': 'User: guest\nContact: vibeagency.oficial@gmail.com',
